...
export const ClassicTemplate: React.FC<PreviewProps> = ({ data, language, onChange }) => {
  ...
  return (
    <div id="cv-preview" className="bg-white w-full min-h-[29.7cm] p-[15mm] text-gray-900 font-sans relative">
      ...
      <header className="border-b border-gray-300 pb-6 mb-6">
        <div className="flex flex-col md:flex-row md:items-start gap-6">
          ...
          <div className="flex-grow text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 text-center text-sm text-gray-600 mt-4">
      ...
      <div className="space-y-8">
        ...
        {summary && (
          <section>
            <h2 className="text-xl font-bold border-b pb-1 mb-3 uppercase tracking-wide">
              {t.summary}
            </h2>
            <p 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-8">
            ...
            {experience.length > 0 && (
              <section>
                <h2 className="text-xl font-bold border-b pb-1 mb-4 uppercase tracking-wide">
                  {t.experience}
                </h2>
                  ...
                  {experience.map((exp) => (
                    <div key={exp.id} className="break-avoid">
                      <div className="flex justify-between">
                        <h3 
                          className="text-lg font-bold cursor-text border-b border-dashed border-gray-400 hover:border-gray-600"
                      ...
                      <div 
                        className="text-base font-semibold text-gray-700 mb-2 cursor-text border-b border-dashed border-gray-400 hover:border-gray-600"
                ...
                <div className="space-y-6">
                  {education.map((edu) => (
                    <div key={edu.id} className="break-avoid">
                      ...
                      <div 
                        className="text-base font-semibold text-gray-700 mb-1 cursor-text border-b border-dashed border-gray-400 hover:border-gray-600"
              ...
              <section>
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.map((skill, index) => (
                    <span 
                      key={index} 
                      className="text-sm font-bold border border-gray-300 px-3 py-1 bg-gray-50 cursor-text"
