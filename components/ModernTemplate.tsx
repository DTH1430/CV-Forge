...
export const ModernTemplate: React.FC<PreviewProps> = ({ data, language, onChange }) => {
          ...
          {personalInfo.profilePicture && (
            <div className="flex-shrink-0">
              <img
                ...
                alt="Profile"
                className="w-24 h-24 rounded object-cover border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
              />
            </div>
          )}
